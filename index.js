...
//will set your mongo url
cs.setMongoURL('mongodb+srv://levelsystem:levelsystem@cluster0.2aynn.mongodb.net/myFirstDatabase?retryWrites=true&w=majority');
cs.setDefaultWalletAmount('100'); //default wallet amount
cs.setDefaultBankAmount('1000'); //default bank amount
client.cs = cs;


client.on("ready", async () => {
  console.log(`Yo boii!! Economy.V1 has been deployed!! 🚀 Coded by 365 ɢᴀᴍɪɴɢ ɴ ᴍᴏʀᴇ_2.0#0002`);
  client.user
...
modules.forEach(function(module) {
  fs.readdir(`./commands/${module}`, function(err, files) {
    ...
    files.forEach(function(file) {
      ...
      console.log(`${command.name} Command Has Been Deployed - ✔️`);
